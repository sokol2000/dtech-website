          ...
          {CASES.map((c, i) => (
            <Reveal key={c.client} delay={(i % 4) * 0.08} y={30}>
              ...
              >
                ...
                <div className="relative h-20 w-20 overflow-hidden rounded-full bg-ink-950 ring-1 ring-white/10 transition-transform duration-500 ease-out group-hover:scale-105 sm:h-28 sm:w-28">
                  <img
                    src={c.logo}
                    alt={c.client}
                    loading="lazy"
